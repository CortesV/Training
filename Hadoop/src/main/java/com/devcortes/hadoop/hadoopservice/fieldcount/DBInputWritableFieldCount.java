...
public class DBInputWritableFieldCount implements Serializable, Writable, DBWritable {
	...
	public DBInputWritableFieldCount() {

	}

	public DBInputWritableFieldCount(Integer id, String uuid, Integer yearProduce, String brand, String model, String color,
			Integer price) {
		this.id = id;
		this.uuid = uuid;
